...
<section class="py-8 md:px-20 lg:px-24 xl:px-24">
  ...
  <div class="container-fluid grid gap-2">
    ...
    <p><strong class="font-semibold text-black">1. Introduction</strong></p>
    ...
    <p><strong class="font-semibold text-black">2. Eligibility</strong></p>
    <p class="text-sm text-justify">
    ...
    <p><strong class="font-semibold text-black">3. Account Registration</strong></p>
    <p class="text-sm text-justify">
    ...
    <p><strong class="font-semibold text-black">4. Product Information</strong></p>
    <p class="text-sm text-justify">
    ...
    <p><strong class="font-semibold text-black">5. Pricing and Payment</strong></p>
    <p class="text-sm text-justify">
    ...
    <p><strong class="font-semibold text-black">6. Shipping and Delivery</strong></p>
    <p class="text-sm text-justify">
    ...
    <p><strong class="font-semibold text-black">7. Returns and Refunds</strong></p>
    <p class="text-sm text-justify">
    ...
    <p><strong class="font-semibold text-black">8. Intellectual Property</strong></p>
    <p class="text-sm text-justify">
    ...
    <p><strong class="font-semibold text-black">9. User Conduct</strong></p>
    <p class="text-sm text-justify">
    ...
    <p><strong class="font-semibold text-black">10. Privacy</strong></p>
    <p class="text-sm text-justify">
    ...
    <p><strong class="font-semibold text-black">11. Limitation of Liability</strong></p>
    <p class="text-sm text-justify">
    ...
    <p><strong class="font-semibold text-black">12. Governing Law</strong></p>
    <p class="text-sm text-justify">
    ...
    <p><strong class="font-semibold text-black">13. Changes to Terms & Conditions</strong></p>
    <p class="text-sm text-justify">
    ...
    <p><strong class="font-semibold text-black">14. Contact Information</strong></p>
    <p class="text-sm text-justify">
