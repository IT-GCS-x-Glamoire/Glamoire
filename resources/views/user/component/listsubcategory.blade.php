  ...
  <div class="container-fluid">
    <div class="shadow-sm border border-black rounded-md py-2 py-md-3 my-2 my-md-3">
      <div class="d-flex gap-2 pl-2">
        ...
        <p class="text-[8px] md:text-[10px] lg:text-[12px] xl:text-[14px]"> > </p>
        <a href="/belanja-{{$category}}-{{$subcategory}}-{{$listsubcategory}}" class="text-black text-[8px] md:text-[10px] lg:text-[12px] xl:text-[14px]">{{ $listsubcategory }}</a>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 col-md-3 d-none d-md-block">
        ...
        <div class="border border-black shadow-md rounded-md md:mb-0 lg:mb-0 xl:mb-0 py-1 px-3">
          ...
          <form action="{{ route('shop.category.sub.list', ['category' => $category, 'subcategory' => $subcategory, 'listsubcategory' => $listsubcategory]) }}" method="GET" id="form-filter-listsubcategory">
            <!-- Categories Start -->
              ...
              <div class="row">
                <div class="flex w-full align-items-center justify-content-between p-0 m-0 mb-2 mb-my-4">
                  <div class="flex justify-content-center align-items-center gap-3">
                    <h1 class="text-lg text-[#183018]">{{ $listsubcategory }}</h1>
                  </div>
