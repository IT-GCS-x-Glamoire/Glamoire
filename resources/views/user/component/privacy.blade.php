...
<section class="mb-2 mb-md-4 md:px-20 lg:px-24 xl:px-24">
  <div class="container-fluid">
    <div class="shadow-sm border border-black rounded-md py-2 py-md-3 my-1 my-md-3">
      <div class="d-flex gap-2 pl-2">
        ...
        <a href="#" class="text-decoration-none text-black text-[7px] md:text-[10px] lg:text-[12px] xl:text-[14px]">Kebijakan Privasi</a>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid grid gap-2">
    ...
    <p><strong class="font-semibold text-black">1. Information We Collect</strong></p>
    <p class="text-sm">
    ...
    <p><strong class="font-semibold text-black">2. How We Use Your Information</strong></p>
    <p class="text-sm">
    ...
    <p><strong class="font-semibold text-black">3. How We Protect Your Information</strong></p>
    <p class="text-sm">
    ...
    <p><strong class="font-semibold text-black">4. Sharing Your Information</strong></p>
    <p class="text-sm">
    ...
    <p><strong class="font-semibold text-black">5. Cookies</strong></p>
    <p class="text-sm">
    ...
    <p><strong class="font-semibold text-black">6. Third-Party Links</strong></p>
    <p class="text-sm">
    ...
    <p><strong class="font-semibold text-black">7. Your Consent</strong></p>
    <p class="text-sm">
      By using our site, you consent to our Privacy Policy.
    </p>

    <p><strong class="font-semibold text-black">8. Changes to Our Privacy Policy</strong></p>
    <p class="text-sm">
    ...
    <p><strong class="font-semibold text-black">9. Contact Us</strong></p>
    <p class="text-sm">
