...
<div class="md:px-20 lg:px-24 xl:px-24 pt-2">
    ...
    <div class="row gap-2 gap-md-0 m-0 p-0 mb-4">
        <div class="col-md-8 grid gap-2">
            ...
            <div class="col-12 p-0 md:shadow-md md:rounded p-md-3 py-2 py-md-0 border-bottom border-top md:border-none">
                <h1 class="font-semibold text-black text-[12px] md:text-[12px] lg:text-[14px] xl:text-[16px] mb-2">Rincian Pengiriman</h1>
                <div class="grid gap-1 gap-md-2 mb-md-2">
            ...
            @foreach ($data['cartItems'] as $product)
                <div class="col-12 p-0 py-1 py-md-0 md:shadow-md md:border border-bottom border-top md:rounded p-md-3">
                    ...
                    <div class="flex">
                        <div class="w-[70px] h-[70px] w-md-[110px] h-md-[110px]">
                            <img src="images/produk1.png" alt="gambar produk" class="rounded-md border">
                        </div>
                        <div class="col p-0">
                            <div class="d-flex col-12 gap-1 gap-md-2 mb-2 h-[20px] h-md-[20px]">
                                <img class="rounded-md" src="images/l-1.png" alt="logo brand" style="background-color:#183018">
                                <p class="font-semibold text-black text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]">Glamoire</p>
                            </div>
                            <div class="grid lg:flex">
                                <div class="col-lg-10">
                                    <p class="text-black text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]">Nama Produk {{ $product->product_id }}</p>
                                </div>
                ...
                <div class="p-3 bg-light rounded shadow-sm border border-[#183018] grid gap-2 gap-md-3">
                    ...
                    <div class="grid">
                        <div class="d-flex">
                            ...
                            <p class="text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px] ml-auto">({{ number_format($data['totalPrice'], 0, ',', '.') }})</p>
                    ...
                    <div>
                        <form action="" id="code-voucher-form" class="grid gap-2">
                            ...
                            <div class="d-flex gap-1">
                                <input type="text" class="form-control w-full rounded-md text-[10px] md:text-[10px] lg:text-[14px] xl:text-[16px]" id="code_voucher" placeholder="Masukkan kode promo">
                    ...
                    <button type="button" class="d-flex align-items-center btn btn-primary rounded-md text-black text-[6px] md:text-[10px] lg:text-[12px] xl:text-[14px]" data-bs-toggle="modal" data-bs-target="#promo" style="background-color: #FFFFFF">
                    ...
                    <button class="btn w-full rounded-md text-white text-[10px] md:text-[12px] lg:text-[14px] xl:text-[16px]" style="background-color: #183018" type="submit" id="paynow">
                        Bayar Sekarang
                    </button>
                </div>
            </div>
