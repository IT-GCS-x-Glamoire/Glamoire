<footer class="mb-12 mb-lg-0">
  <div class="container-fluid text-dark">
    <div class="row" style="background-color: #183018">
      <div class="py-2 d-flex items-center ml-auto justify-between md:px-20 lg:px-24 xl:px-24 2xl:px-96">
        <img class="w-1/3" style="max-width:250px;" src="images/l-1.png" alt="Image">
        <p class="text-white text-[12px] md:text-[12px] lg:text-[20px] xl:text-[32px] mx-auto text-center aclonica-regular">1st Plant-Based Beauty Commerce in Indonesia</p>
      </div>
    </div>
    ...
    <div class="row md:px-20 lg:px-24 xl:px-24 2xl:px-96 pt-2 md:pt-5 lg:pt-5 xl:pt-5">
      <div class="col col-lg-10 col-md-6 col-md-12 pr-3 pr-xl-5">
        <p class="text-dark text-[7px]  md:text-[10px] lg:text-[12px] xl:text-[14px] mb-2 md:mb-3 lg:mb-3 xl:mb-3">
          At Glamoire, we are committed to providing you with high-quality, plant-based cosmetic products. Our mission is to ensure that beauty doesn’t come at the expense of the environment. Discover the beauty of nature with Glamoire.
        </p>
        <div class="d-flex content-start gap-2 text-[7px]  md:text-[10px] lg:text-[12px] xl:text-[14px]">
      ...
      <div class="xl-md-3 col-lg-2 text-start text-lg-end lg:flex lg:items-end lg:justify-end">
        <ul id="footer-navigasi" class="decoration-none d-flex justify-content-between gap-1">
          <li>
            <a class="text-dark text-[6px] md:text-[10px] lg:text-[12px] xl:text-[14px]" href="/about">About Us</a>
          </li>
          <li>
            <a class="text-dark text-[6px] md:text-[10px] lg:text-[12px] xl:text-[14px]" href="/contact">Contact Us</a>
          </li>
          <li>
            <a class="text-dark text-[6px] md:text-[10px] lg:text-[12px] xl:text-[14px]" href="/privacy">Privacy Policy</a>
          </li>
          <li>
            <a class="text-dark text-[6px] md:text-[10px] lg:text-[12px] xl:text-[14px]" href="/terms">Terms & Condition</a>
          </li>
          <li>
            <a class="text-dark text-[6px] md:text-[10px] lg:text-[12px] xl:text-[14px]" href="/help">Help Center</a>
          </li>
          <li>
            <a class="text-dark text-[6px] md:text-[10px] lg:text-[12px] xl:text-[14px]" href="/partner">Bussiness Partner</a>
          </li>
      </div>
    </div>
...
<div class="d-lg-none fixed-bottom">  
  ...
  <div class="container-fluid py-2" style="background-color:#183018;">
    <div class="d-flex text-center text-white justify-content-between">
      ...
      <div>
        <a class="d-flex flex-column justify-content-center align-items-center p-0 text-decoration-none" href="/promo">
      ...
      <!-- AKUN -->
      <a class="d-flex flex-column justify-content-center align-items-center p-0 text-decoration-none" href="/account">
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ffffff" d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z"/></svg>
        <p class="p-0 text-white text-[9px] md:text-[10px] lg:text-[11px] xl:text-[12px]" href="/account" role="button" data-bs-toggle="dropdown" aria-expanded="false">Akun</p>
      </a>
    </div>
  </div>
</div>
