...
<head>
    ...
    <title>Promo Ongkir || Admin Glamoire</title>
                ...
                <div class="page-title">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>All Promo Ongkir</h3>
                            <nav aria-label="breadcrumb" class="breadcrumb-header me-3">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="index.html">Promo Ongkir</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">All Promo Ongkit</li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div
                            ...
                            <a href="{{ route('create-promo-ongkir') }}" type="submit"
