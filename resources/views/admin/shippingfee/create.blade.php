                        ...
                        <div class="col-12 col-md-6 d-flex justify-content-md-end align-items-center">
                            <nav aria-label="breadcrumb" class="breadcrumb-header" style="margin-bottom: 20px;">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="/product-admin">Shipping Fee</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add New Shipping Fee</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        <form class="form form-vertical">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="first-name-icon">Rincian Harga Pengiriman<span
                                                                    style="color: red">*</span></label>
                                                            <div class="d-flex align-items-center mt-2">
                                                                <!-- Input: Regular Price -->
                                                                <div class="position-relative me-2 flex-grow-1">
                                                                    <input type="text" class="form-control"
                                                                        placeholder="Kota" id="first-name-icon">
