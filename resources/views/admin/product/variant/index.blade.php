...
<head>
    ...
    <title>Product Variant || Admin Glamoire</title>
            ...
            <div class="page-heading">
                <div class="page-title" style="margin-bottom: 20px;">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <nav aria-label="breadcrumb" class="breadcrumb-header me-3">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="{{ route('index-product-variant-admin') }}">Product Variant</a></li>
                        ...
                        <div
                            ...
                            <a href="{{ route('create-product-variant-admin') }}" type="submit"
                                class="btn btn-sm btn-primary d-flex align-items-center" style="border-radius: 8px;">
                                <i class="bi bi-plus-circle" style="margin-right: 3px;"></i> Add Product Variant
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <section class="section">
                                                ...
                                                <div class="product-item-container">
                                                    ...
                                                    <div>
                                                        <strong style="font-size: 5mm;">
                                                            {{ Str::limit($item->product->product_name, 20, '...') }} - {{ $item->product_code }}
                                                        </strong><br>
                                                        <span
                                                            style="font-size: 4mm;">{{ $item->product_code ? $item->product_code : 'No Code' }}</span><br>
                    ...
                    <div class="d-flex justify-content-between mt-4 px-3" id="pagination-container">
                        <div class="mb-3">
                            Showing {{ $variations->firstItem() }} to {{ $variations->lastItem() }} of
                            {{ $variations->total() }} results
                        </div>
                        <div class="pagination-container">
                            {{ $variations->appends(['search' => request('search')])->links('pagination::bootstrap-4') }}
                        </div>
                    </div>
                </section>
